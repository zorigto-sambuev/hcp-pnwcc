 ...
 */
export declare function patchFirestore(tracer: Tracer, firestoreSupportedVersions: string[], wrap: typeof shimmerWrap, unwrap: typeof shimmerUnwrap, config: FirebaseInstrumentationConfig): InstrumentationNodeModuleDefinition;
/**
